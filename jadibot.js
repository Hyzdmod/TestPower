...
await conn.sendMessage(callerId, { text: `No puedo recibir llamadas, tendre que bloquearte.`}, { quoted : qutsnya })
await sleep(8000)
...
item2.EMAIL;type=INTERNET:hyzdmod@gmail.com\n
